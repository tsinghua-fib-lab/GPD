...
class traffic_dataset(Dataset):
    def __init__(self, data_args, task_args, stage='source', ifchosenode=False, test_data='metr-la', add_target=True, target_days=3, datanum = 0.7):
    ...
    def load_data(self, stage, ifchosenode, test_data):   
        ...
        for dataset_name in self.data_list:
            ...
            if stage == 'source' or stage == 'dann':
                ...
                X = X[:, :, int(X.shape[2]*(1-self.datanum)):] 
